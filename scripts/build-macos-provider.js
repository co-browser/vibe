...
const paths = {
  ...
  macOsProject: "../macos-autofill/vibe.xcodeproj",
};
...
async function buildMacOs() {
  ...
  if (configurationArgument !== undefined) {
    ...
    if (configurationArgument == "mas-dev") {
      ...
      provisioningProfileSpecifier = "Vibe Browser Desktop Autofill Development 2025";
      ...
      provisioningProfileSpecifier = "3rd Party Mac Developer Application: Ryan MacArthur (UVTLR432J3)";
